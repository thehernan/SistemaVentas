...
public class UsuarioSingleton {
    ...
    public UsuarioSingleton(long id_usuario, String usuario, String clave, long idempleado, boolean cliente, boolean proveedor, boolean apertura, boolean consultarrepara, boolean consultarventa, boolean debe, boolean ckempleado, boolean familia, boolean haber, boolean ingreso, boolean inventario, boolean movimientos, boolean nueva, boolean pendientes, boolean productos, boolean useri, boolean vender, String tema, boolean extornar, boolean prodpendientes, boolean mermas, boolean consulmermas, boolean sucursalida, boolean sucurentrada, boolean consultasucur) {
